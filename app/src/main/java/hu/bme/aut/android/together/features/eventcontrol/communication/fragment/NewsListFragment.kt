...
import hu.bme.aut.android.together.features.eventcontrol.dialogfragment.EventPostNewsDialogFragment
...
class NewsListFragment : Fragment() {
     ...
     * of the dialog.
     */
    private fun showNewsInformationInDialog(eventMessage: EventInvitation) {
